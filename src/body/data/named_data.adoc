...
// TODO This should probably be broken up into different sections:
// 1. Identifiers (talk about binding, scope, lifecycle, etc.)
// 2. Identifiers for data (variables and constants)
